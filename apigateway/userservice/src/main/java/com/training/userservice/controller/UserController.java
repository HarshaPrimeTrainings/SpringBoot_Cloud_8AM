...
public class UserController {
	...
	public ResponseEntity<String>  greet() {
		 String resp = restTemplate.getForObject("http://ORDERSERVICE"+"/greet", String.class);
	...
	public ResponseEntity<UserDto> getUserDetails(@PathVariable Integer uid){
		...
		List<OrderDto> orders = restTemplate.getForObject(orderservice+"/order/"+uid, List.class);
